...
export const metadata: Metadata = {
  title: "BrewCafe - Premium Coffee & Cozy Community Space",
  description: "Experience artisanal coffee crafted with passion in our welcoming neighborhood coffee shop. Fresh roasted daily, perfect atmosphere for work or relaxation.",
  keywords: "coffee shop, artisanal coffee, fresh roasted, espresso, cappuccino, latte, cozy cafe, neighborhood coffee, premium beans",
  metadataBase: new URL("https://brewcafe.com"),
  alternates: {
    canonical: "https://brewcafe.com"
  },
  openGraph: {
    title: "BrewCafe - Premium Coffee & Cozy Community Space",
    description: "Experience artisanal coffee crafted with passion in our welcoming neighborhood coffee shop.",
    siteName: "BrewCafe",
    images: [{
